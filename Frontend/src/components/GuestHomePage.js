...
const { TabPane } = Tabs;//不解构的话就用Tabs.TabPane
...
class SearchStays extends React.Component {
  ...
  render() {
    return (
      <>
        <Form onFinish={this.search} //实际上这些都是传递给其他component的porps
          layout="inline" //使得form平铺以给搜索结果留出空间
        >
          <Form.Item
            label="Guest Number"
            name="guest_number"
