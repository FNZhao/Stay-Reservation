...
@Component
public class JwtFilter extends OncePerRequestFilter {//每次都要check//在SecuritConfig里加进去的
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (jwt != null && jwtUtil.validateToken(jwt) && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (authority != null) {
                ...
                SecurityContextHolder.getContext().setAuthentication(usernamePasswordAuthenticationToken);//这个就是set principal（authentication extends principal）
            }
        }
